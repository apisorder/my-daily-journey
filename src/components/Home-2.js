...
import TexAreaStyled from './TextAreaStyled';
...
const Home = () => {
    ...
    // create a new one and add to the existing pile, but its value will be initialized later
    ...
    // find all stickies which are not the one to be added, as to remove the duplicate entry
